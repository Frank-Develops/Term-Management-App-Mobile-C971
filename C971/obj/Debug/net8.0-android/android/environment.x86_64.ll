...
@dso_cache = dso_local local_unnamed_addr global [44 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1349225438180560207, ; hash 0x12b9696334ac4d4f, from name: sqlite3
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libsqlite3.so
		ptr null; void* handle (0x0)
	}, ; 1
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 4095290392931022346, ; hash 0x38d564ea22b9360a, from name: libsqlite3.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libsqlite3.so
		ptr null; void* handle (0x0)
	}, ; 6
	...
	%struct.DSOCacheEntry {
		i64 7500726413109874257, ; hash 0x6817eeeea2cdce51, from name: sqlite3.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libsqlite3.so
		ptr null; void* handle (0x0)
	}, ; 18
	%struct.DSOCacheEntry {
		i64 7620443568065509501, ; hash 0x69c1410ce174787d, from name: libsqlite3
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libsqlite3.so
		ptr null; void* handle (0x0)
	}, ; 19
...
@.env.7 = private unnamed_addr constant [37 x i8] c"9802a417-f871-4f6d-8132-16357a2827cf\00", align 16
...
@.DSOCacheEntry.10_name = private unnamed_addr constant [14 x i8] c"libsqlite3.so\00", align 1
